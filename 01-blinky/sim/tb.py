"""cocotb testbench for example_counter.

Placeholder until 01-blinky grows custom RTL. The deployed design uses
an off-the-shelf AXI GPIO IP, so for now this just proves the sim flow
works end-to-end.
"""
import cocotb
